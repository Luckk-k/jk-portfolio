...
const projectLibrary = [
  {
    ...
    details: {
      ...
      responsibility: "负责产品标准化体系建设，管理 6 人产品标准化团队，统筹产品经理、文档工程师、UI 设计师与销售、售前、交付等角色的协作节奏。",
...
const careerPath = [
  {
    ...
    text: "负责产品标准化体系、销售 / 服务工具包、版本发布、资质管理、伙伴接入和政企方案支持，管理 6 人产品标准化团队。重点推动项目制经验向产品化材料沉淀，围绕产品定义、评审流程、发布节奏、售前材料和交付边界建立统一口径，并参与大模型应用、知识图谱、协同平台等政企方案判断。",
    tags: ["标准化体系", "政企方案", "6 人团队"],
    highlight: true
  },
  {
